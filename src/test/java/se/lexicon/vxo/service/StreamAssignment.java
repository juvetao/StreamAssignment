...
public class StreamAssignment {
    ...
    public void task7(){
        ...
        optional = people.stream()
                ...
                .min(Comparator.comparingInt(Person::getPersonId));
    ...
    public void task11(){
        ...
        averageAge = people.stream()
                ...
                .average()
                .orElse(-1);// convert OptionalDouble into double
    ...
    public void task14(){
        ...
        //Write code here
        _2020_dates = Stream.iterate(LocalDate.ofYearDay(2020,1), localDate -> localDate.isBefore(LocalDate.of(2021, 1,1)), localDate -> localDate.plusDays(1))
